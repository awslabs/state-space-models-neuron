"""NKI implementation of the forward and backward SSM kernels for a Mamba2 model (https://arxiv.org/abs/2405.21060)."""
...
class Mamba2Kernel(torch.autograd.Function):
    """Define the autograd function with forward and backward kernel."""
